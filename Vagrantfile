...
$mongoInitScript = <<-"SCRIPT"
  YUM_REPO_CONFIG_PATH="/etc/yum.repos.d/mongodb-org-3.2.repo"
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define :mongo1 do |mongo1|
    mongo1.vm.network :private_network, ip: "192.168.42.120"
  ...
  config.vm.define :mongo3 do |mongo3|
    mongo3.vm.network :private_network, ip: "192.168.42.100"
    mongo3.vm.provision "shell", inline: $mongoInitScript
    mongo3.vm.provision "shell", inline: $rsInitScript
  end
